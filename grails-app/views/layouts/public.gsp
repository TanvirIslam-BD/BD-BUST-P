...
<head>
    ...
    <title>
        <g:layoutTitle default="Sign Up Member"/>
    </title>
        ...
        <div class="container" style="margin-top: -49px;">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-2 mt-5"> <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="/">Online Bus Ticket Booking System</a></h1>
                </div>
            </div>
        </div>
    </div>
