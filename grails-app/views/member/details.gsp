        ...
        <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
                <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link mb-0 px-0 py-1  member-status ${member.isActive ? "active" : ""}" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                           <span class="ms-1">Active</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mb-0 px-0 py-1 active member-type" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                            <span class="ms-1"> ${member.memberType}</span>
                        </a>
                    </li>
        ...
        <div class="col-12 col-xl-4">
            <div class="card h-100">
                ...
                <div class="card-body p-3">
                    <p class="text-sm">
                        Hi, I’m  ${member.firstName} ${member.lastName}, Decisions: If you can’t decide, the answer is no. If two equally difficult paths, choose the one more painful in the short term (pain avoidance is creating an illusion of equality).
                    </p>
                    <hr class="horizontal gray-light my-4">
                    <ul class="list-group">
                        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp;   ${member.firstName} ${member.lastName}</li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp;   ${member.mobile}</li>
