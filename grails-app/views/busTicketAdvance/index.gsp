                 ...
                 <div class="row">
                    ...
                    <div class="col-md">
                        <div class="form-group has-success">
                            ...
                            <div class="col-md">
                                <select class="form-control valid" data-val="true" data-val-required="The Time field is required." id="ScheduleId" name="ScheduleId" aria-describedby="ScheduleId-error" aria-invalid="false">
