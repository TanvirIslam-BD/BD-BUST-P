            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 seat-design-map-ui">
                ...
                <g:if test="${busTicket.coach.seatMap}">
                    <div class="row" id="seat-design">
                       <div id="seat-map" class="seat-panel seatCharts-container" femalebookedseats="${femaleBookedSeats.seatBooked.toString()}" extraseatinlastrow="${busTicket.coach.seatMap.extraSeatInLastRow}" bookedseats="${busTicket.purchaseTickets.seatBooked.toString()}" price="${busTicket.fares.amount}" rows="${busTicket.coach.seatMap.seatRows}" columns="${busTicket.coach.seatMap.seatColumns}" >
